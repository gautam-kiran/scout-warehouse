...
public class OrderItemRow extends LookupRow<OrderItemKey> {
  public OrderItemRow(Long itemNr, Long productNr, Long orderItemType,Long variant, String itemNo, String text) {
    super(new OrderItemKey(itemNr,productNr,orderItemType,variant,itemNo ),text);
  }
